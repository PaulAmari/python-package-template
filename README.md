...
| `minimal_python_version` | `3.10`                       | Minimal Python version. One of `3.10` and `3.11`. It is used for builds, GitHub workflow and formatters (`black`, `isort` and `pyupgrade`). |
